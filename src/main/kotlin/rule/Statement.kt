...
class LinguisticVariable private constructor(
    ...
    companion object {
        ...
        fun get(name: String) =
            allLinguisticVariablesByName[name] ?: throw Exception("LinguisticVariable $name not found")
...
class Statement(
    private val variable: LinguisticVariable,
    private val value: LinguisticValue,
